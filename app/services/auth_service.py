...
Business logic for user authentication, token management, and password operations.
This service is completely independent and follows enterprise-grade patterns.
"""
